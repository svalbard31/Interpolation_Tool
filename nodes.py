...
print(f"Maxium error occured at x = {xrange[errors[0][1].index(max(errors[0][1]))]} for newton and x = {xrange[errors[0][0].index(max(errors[0][0]))]} for lagrange at 10 nodes")
print(f"Maxium error occured at x = {xrange[errors[1][1].index(max(errors[1][1]))]} for newton and x = {xrange[errors[1][0].index(max(errors[1][0]))]} for lagrange at 20 nodes")
print(f"Maxium error occured at x = {xrange[errors[2][1].index(max(errors[2][1]))]} for newton and x = {xrange[errors[2][0].index(max(errors[2][0]))]} for lagrange at 40 nodes")
